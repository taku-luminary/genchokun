...
export function CheckboxChip({ label, ...props }: Props) {
  return (
    <label className="group inline-flex max-w-full min-h-11 cursor-pointer items-center gap-1 rounded-3xl border-2 border-slate-300 bg-white px-3.5 py-2 text-sm leading-snug text-slate-700 transition has-checked:border-brand-green has-checked:bg-brand-green has-checked:font-bold has-checked:text-white has-focus-visible:ring-2 has-focus-visible:ring-brand-green has-focus-visible:ring-offset-2 has-disabled:cursor-not-allowed has-disabled:opacity-50">
