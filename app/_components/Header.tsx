        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4 md:gap-8">
            {user ? (
              ...
              <>
                <a href="/signup" className="text-sm font-bold text-slate-600 hover:text-brand-green
  transition-colors">会員登録</a>
                <a href="/login" className="text-sm font-bold text-slate-600 hover:text-brand-green
  transition-colors">ログイン</a>
              </>
            )}
          </nav>
        </div>
